...
import club.ihere.common.api.entity.Article;
import club.ihere.common.api.enums.MediaType;
import club.ihere.common.api.response.*;
import club.ihere.common.util.current.fastjson.JSONUtil;
import club.ihere.common.util.http.HttpClientUtil;
import club.ihere.common.util.current.StreamUtil;
...
public class MediaAPI extends BaseAPI {
    ...
    public DownloadMediaResponse downloadMedia(String mediaId) {
        ...
        RequestConfig config = RequestConfig.custom().setConnectionRequestTimeout(HttpClientUtil.CONNECT_TIMEOUT).setConnectTimeout(HttpClientUtil.CONNECT_TIMEOUT).setSocketTimeout(HttpClientUtil.CONNECT_TIMEOUT).build();
