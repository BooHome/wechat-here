package club.ihere.common.util.current.fastjson;
...
import static club.ihere.common.util.current.BeanUtil.requireNonNull;
import static club.ihere.common.util.current.StringUtil.isBlank;
