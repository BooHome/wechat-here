package club.ihere.common.util.http;
...
public class HttpClientUtil {
    ...
    public static BaseResponse post(String url, String paramData) {
        ...
        post(url, paramData, new ResponseCallback() {
            @Override
            public void onResponse(int resultCode, String resultJson) throws Exception {
                if (RESULT_CODE == resultCode) {
                    BaseResponse r = JsonUtil.fromJson(resultJson, BaseResponse.class);
...
//	@FunctionalInterface
    public interface ResponseCallback {
         ...
         */
        void onResponse(int resultCode, String resultJson) throws Exception;
    }
}
